export const orderProcessorARBContractAddress =
...
export const orderProcessorAbi = [
    ...
    outputs: [
      {
        name: '',
        type: 'tuple',
        internalType: 'struct OrderProcessor.FeeRates',
        components: [
          {
            name: 'perOrderFeeBuy',
            type: 'uint64',
  ...
  {type: 'error', name: 'OrderCancellationInitiated', inputs: []},
  ...
  {type: 'error', name: 'OrderTypeMismatch', inputs: []},
  {
    type: 'error',
