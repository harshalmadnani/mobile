              ...
              <View
                ...
                <View style={styles.senderContainer}>
                  ...
                  <Text style={styles.senderAddressText}>
                    {transactionData.from.substring(0, 5)}.......
                    {transactionData.from.substring(
                      transactionData.from.length - 5,
                      transactionData.from.length - 1,
                    )}
                  </Text>
                </View>
                <View style={styles.receiverContainer}>
                  ...
                  <Text style={styles.receiverAddressText}>
                    {transactionData.to.substring(0, 6)}.......
                    {transactionData.to.substring(
                      transactionData.to.length - 5,
                      transactionData.to.length - 1,
                    )}
                  </Text>
                </View>
              </View>
