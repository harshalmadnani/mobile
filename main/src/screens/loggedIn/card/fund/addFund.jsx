...
const AddFund = ({navigation}) => {
  ...
  const [paymentRequestHistoryLoading, setPaymentRequestHistoryLoading] =
    useState(false);
  ...
  const handleSubmit = async () => {
    try {
      ...
      const transactionData = await client.paymentRequest.getWeb3PaymentParams({
        ...
        paymentTokenAddress: '0x3c499c542cEF5E3811e1192ce70d8cC03d5c3359', // USDC on mainnet
      });
      ...
      const payment = await client.payment.getForPaymentRequest(
        paymentRequest.id,
      );
