...
const AddBankAccount = ({navigation}) => {
  ...
  const [selectedBankAccountSubType, setSelectedBankAccountSubType] =
    useState();
  // BankAccountSubType.Savings,
  const bankAccountSubTypeOptions = [
    // BankAccountSubType.Savings,
  ...
  const handleFormSubmit = async () => {
    ...
    try {
      ...
      //   //   const bankAccounts = await client.bankAccount.create(
  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity
        ...
        <View>
          <Icon name={'chevron-left'} size={24} color={'#fff'} type="entypo" />
        </View>
      </TouchableOpacity>
          ...
          <View style={styles.pickerContainer}>
            <Picker
              ...
              onValueChange={itemValue =>
                setSelectedBankAccountSubType(itemValue)
              }>
