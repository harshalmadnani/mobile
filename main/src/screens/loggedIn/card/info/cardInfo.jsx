            ...
            {verificationStatus === 'ACTIVE' && (
              <View style={styles.cardDetailContainer}>
                <LinearGradient
                  ...
                  <View style={styles.cardDetailRow}>
                    <Text style={styles.cardDetailLabel}>Currency</Text>
                    <Text style={styles.cardDetailValue}>
                  ...
                  <View style={styles.cardDetailRow}>
                    <Text style={styles.cardDetailLabel}>Card Type</Text>
                    <Text style={styles.cardDetailValue}>
                ...
                <LinearGradient
                  ...
                  <View style={styles.cardDetailRow}>
                    <Text style={styles.cardDetailLabel}>Email</Text>
                    <Text style={styles.cardDetailValue}>
                  ...
                  <View style={styles.cardDetailRow}>
                    <Text style={styles.cardDetailLabel}>Phone</Text>
                    <Text style={styles.cardDetailValue}>
                ...
                <LinearGradient
                  ...
                  <View style={styles.cardDetailRow}>
                    <Text style={styles.cardDetailLabel}>Street Address</Text>
                    <Text style={styles.cardDetailValue}>
                  ...
                  {virtualCardInfo.billingInfo.address.street2 !== null && (
                    <View style={styles.cardDetailRow}>
                      <Text style={styles.cardDetailLabel}>Street Line 2</Text>
                      <Text style={styles.cardDetailValue}>
                  ...
                  <View style={styles.cardDetailRow}>
                    <Text style={styles.cardDetailLabel}>City</Text>
                    <Text style={styles.cardDetailValue}>
                  ...
                  <View style={styles.cardDetailRow}>
                    <Text style={styles.cardDetailLabel}>Subdivision</Text>
                    <Text style={styles.cardDetailValue}>
                  ...
                  <View style={styles.cardDetailRow}>
                    <Text style={styles.cardDetailLabel}>Country</Text>
                    <Text style={styles.cardDetailValue}>
                  ...
                  <View style={styles.cardDetailRow}>
                    <Text style={styles.cardDetailLabel}>Postal Code</Text>
                    <Text style={styles.cardDetailValue}>
                ...
                <View style={styles.cardDetailRow}>
                  <Text style={styles.cardDetailLabel}>Generated at</Text>
                  <Text style={styles.cardDetailValue}>
