  ...
  return (
    ...
    <View style={styles.row}>
      ...
      <View style={styles.textContainer}>
        ...
        <Text style={styles.secondLine}>Available across 98+ countries to spend with no limits</Text>
      </View>
    </View>
    <View style={styles.row}>
      <Image
      ...
      <View style={styles.textContainer}>
        ...
        <Text style={styles.secondLine}>Buy giftcards in a single click with no document upload</Text>
      </View>
    </View>
    <View style={styles.row}>
      <Image
      ...
      <View style={styles.textContainer}>
        ...
        <Text style={styles.secondLine}>Get your own customisable virtual or physical metal card </Text>
      </View>
    </View>
    </View>

    <View style={{ flex: 1, justifyContent: 'flex-end', marginBottom: '1%', paddingHorizontal: '1%' }}>
          <TouchableOpacity
onPress={() => navigation.navigate('PreRegister')}
          ...
          >
            <Text style={{ fontSize: 16, color: 'black', fontFamily: 'Unbounded-Bold' }}>
              START SPENDING
            </Text>
          </TouchableOpacity>
        </View>
