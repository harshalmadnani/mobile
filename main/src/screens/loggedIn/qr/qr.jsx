...
import {Text,Modal, View, SafeAreaView, ScrollView, TouchableOpacity, Alert} from 'react-native';
  ...
  render() {
    ...
    return (
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: 'center', alignItems: 'center' }}>
        ...
        >
          <View style={{ flex: 1, justifyContent: 'flex-end', alignItems: 'center', backgroundColor: 'rgba(0,0,,0.5)' ,width:'100%'}}>
            <View style={{ margin: 20, backgroundColor: '#000', borderRadius: 30, padding: '5%', alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.25, shadowRadius: 3.84, elevation: 5 }}>
            <Text style={{ marginBottom: 15, textAlign: 'center',color:'#fff',fontSize:14,fontFamily:'Unbounded-Medium'}}>
            DEPOSIT OTHER ASSETS
              </Text>
              <Text style={{ marginBottom: '10%', textAlign: 'center',color:'#999',fontSize:14,fontFamily:'NeueMontreal-Medium'}}>
            You can deposit assets on any EVM chains using the qr code and sell it on Xade to get cash 
              </Text>
              <TouchableOpacity
